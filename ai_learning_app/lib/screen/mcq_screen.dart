...
// ══════════════════════════════════════════
// MCQ SCREEN — 4 screens:
// 1. MCQList       — all MCQ sets
// 2. GenerateMCQ   — upload PDF → configure → generate
// 3. TakeTest      — timed quiz with progress bar
// 4. TestResults   — score, breakdown, prediction
// ══════════════════════════════════════════
...
class _GenerateMCQScreenState extends State<_GenerateMCQScreen> {
  ...
  Widget _buildUploadStep() {
    return Column(children: [
      ...
      const SizedBox(height: 8),
      const Text(
          'Upload your PDF to create AI-powered\nMCQ questions automatically',
          style: AppTextStyles.sub,
          textAlign: TextAlign.center),
      const SizedBox(height: 40),
      if (_error != null) ...[
        ...
        child: GestureDetector(
            ...
            child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                        color: sel ? color : AppColors.inputBorder,
                        width: 1.5)),
                child: Text(label,
                    textAlign: TextAlign.center,
                    style: TextStyle(
  ...
  Widget _buildGeneratingStep() {
    return SizedBox(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          ShaderMask(
              shaderCallback: (b) => const LinearGradient(
                      colors: [Color(0xFF00C9A7), Color(0xFF48C6EF)])
                  .createShader(b),
            ...
            Expanded(
              ...
              ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                      ...
                      valueColor:
                          const AlwaysStoppedAnimation(Color(0xFF00C9A7)),
                      minHeight: 6)),
              const SizedBox(height: 6),
