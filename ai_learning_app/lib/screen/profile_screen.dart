...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Widget _achievementBadge(
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color:
                    unlocked ? color.withOpacity(0.4) : AppColors.inputBorder)),
        child: Column(children: [
  ...
  Widget _divider() =>
      Divider(color: AppColors.inputBorder, height: 1, thickness: 1);
  ...
  Widget _podiumCard(Map<String, dynamic> user, int rank, double minHeight) {
    ...
    return ConstrainedBox(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              color:
                  isMe ? AppColors.violet.withOpacity(0.2) : AppColors.bgCard,
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
