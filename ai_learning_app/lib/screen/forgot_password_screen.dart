...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen>
          ...
          child: Column(children: [
            ...
            Padding(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: 12),
                  const Text('We sent a password reset link to',
                      style: TextStyle(
                          color: Color(0xFF666666), fontSize: 15, height: 1.7)),
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border(
                              left: const BorderSide(
                                  color: Color(0xFFFF6B6B), width: 4),
                              top: BorderSide(
                                  color: const Color(0xFFFF6B6B)
                                      .withOpacity(0.15)),
                              right: BorderSide(
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border(
                              left: const BorderSide(
                                  color: Color(0xFF6C63FF), width: 4),
                              top: BorderSide(
                                  color:
  ...
  Widget _htmlErrorBox(String msg) => Container(
      ...
      child: Row(children: [
        ...
        Expanded(
            child: Text(msg,
                style:
                    const TextStyle(color: Color(0xFFC53030), fontSize: 13))),
      ]));
  ...
  Widget _htmlFooter() => Container(
      ...
      child: const Text('📚 StudyAI · AI-powered learning for every student',
