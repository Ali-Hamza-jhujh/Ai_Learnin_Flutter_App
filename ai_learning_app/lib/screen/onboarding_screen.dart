...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<_OnboardPage> _pages = const [
    _OnboardPage(
      ...
      title: 'Study Smarter\nwith AI',
      subtitle:
          'Upload any PDF and get instant AI-generated study notes, summaries, and key concepts — in seconds.',
      features: [
        '📄 Upload any PDF',
    ...
    _OnboardPage(
      ...
      title: 'Test Your\nKnowledge',
      subtitle:
          'Generate AI-powered MCQ quizzes from your notes. Choose difficulty, get instant feedback.',
      features: [
        '🎯 Custom difficulty',
        '⚡ Instant results',
    ...
    _OnboardPage(
      ...
      title: 'Your Personal\nAI Tutor',
      subtitle:
          'Chat with your AI tutor 24/7. Ask anything, get step-by-step explanations in real time.',
      features: [
        '💬 Ask anything',
        '📡 Streaming replies',
        '📎 Attach your PDF'
    ...
    _OnboardPage(
      ...
      subtitle:
          'Earn XP, maintain streaks, predict exam scores with AI, and climb the leaderboard.',
      features: [
        '⚡ Earn XP & level up',
        '🔥 Daily streaks',
        '📈 Exam prediction'
